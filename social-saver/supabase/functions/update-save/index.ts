// @ts-nocheck
// supabase/functions/update-save/index.ts
// Accepts: { save_id, user_phone, note }
// Verifies ownership via user_phone hash match before updating.
...
Deno.serve(async (req) => {
    ...
    try {
        const { save_id, user_phone, note } = await req.json()
        ...
        if (updateErr) {
            console.error('[update-save]', updateErr)
        ...
        console.error('[update-save] Unhandled:', err.message)
