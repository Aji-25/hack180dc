            ...
            <section className="relative pt-32 pb-20 px-6 overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    >
                        ...
                        <Button variant="secondary" size="lg" className="h-14 px-8 text-lg rounded-2xl bg-white/5 hover:bg-white/10 border-white/10" onClick={() => window.open('https://wa.me/14155238886?text=join%20social-saver', '_blank')}>
